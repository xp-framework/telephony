 ...
 */
class TelephonyAddressParser extends \lang\Object {
  public 
  ...
  public function parseNumber($number) {
    ...
    if (
      ...
      throw (new \lang\IllegalStateException ('At least one of the default numbers has not been set. Set them before parsing'));
    }
    ...
    $number= preg_replace ('/[^\d]/', '', $number);
    if (strlen ($number) < 3)
      throw (new \lang\FormatException ('No parseable phone number'));
